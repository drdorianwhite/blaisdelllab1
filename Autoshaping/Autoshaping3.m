...
Session.autoReward=1;%automaticly reward at end of trial
...
Session.rewardRate=2; %this is useful but weird. the N is the denominator 2 =1/2 4=1/4...
Trial.rule=' '; 
...
Trial.trialStimOffsetTime=Screen('Flip',Window.window);
end
function MakeStim()
global Session;
global Trial;
...
if Session.ColorRule==0
    ...
    if(colorrand<.5)% make colors, name them and set color based reward rate here
