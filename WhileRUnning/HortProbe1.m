...
global Session;
global Trial;
Session.codeUsed='P019aHortProbeSet1'; %name of the code used for this session
...
Session.expName='P019A Hort Probe 1'; %Name of the experiment
...
Session.trialList(Session.trialList(:,2)<=(((Session.baseLineNum-Session.probeNum)/Session.trialTypes)+Session.probeNum),1)=1; %For half correct makes half 1
...
Session.trialList(Session.trialList(:,2)<=(Session.probeNum/2),1)=3;
Session.trialList(Session.trialList(:,2)<=(Session.probeNum/4),1)=4;
Session.trialList(Session.trialList(:,2)<=(Session.probeNum/6),1)=5;
a=Session.trialList;
...
if Session.trialList(Trial.curTrial) ==3
    dir = 'C:\Users\Admin\Desktop\JULIA\HortProbeCorrect\';
    Trial.type = 'Probe Correct Hort';
    Trial.rewardable=0;
    
elseif Session.trialList(Trial.curTrial) ==4
    dir = 'C:\Users\Admin\Desktop\JULIA\HortProbeMajor1\';
    Trial.type = 'Probe Major Hort';
    Trial.rewardable=0;
elseif Session.trialList(Trial.curTrial) ==5
    dir = 'C:\Users\Admin\Desktop\JULIA\HortProbeMinor1\';
    Trial.type= 'Probe Minor Hort';
    Trial.rewardable=0;
    
elseif Session.trialList(Trial.curTrial) == 1; %see session setup
     dir = 'C:\Users\Admin\Desktop\JULIA\IncorrectMinorH\'; %makes the other option in the 1 if loop this directory
       Trial.type='H Minor';
       Trial.rewardable=0;

elseif Session.trialList(Trial.curTrial) == 2;
%    if Session.level==1;
        dir = 'C:\Users\Admin\Desktop\JULIA\IncorrectMajorH\'; %then use this directory, which only draw major rule violations
        Trial.type='H Major'; %labels this trial type
        Trial.rewardable=0;

else 
         dir = 'C:\Users\Admin\Desktop\JULIA\trainingHorizontalCorrect\'; %then use this directory, which will only draw correct stim
