...
global Session;
global Trial;
Session.codeUsed='P014C Hort'; %name of the code used for this session
...
Session.minPecksToReward=2; %How often the bird is rewarded
Session.maxPecksToReward=5;
Session.totalTrialNumber=100; %total number of trials
Session.sessionLength=60*60; %sessionq length determined by numbeqof each trial type??
...
Session.expName='P014C Hort'; %Name of the experiment
...
function RunStim() %function that runs the training stim
    ...
    elseif Session.trialList(Trial.curTrial) == 1;
        ...
        dir = 'C:\Users\Admin\Desktop\temp\JULIA\HortMinorLvlOneP014C\'; %makes the other option in the 1 if loop this directory
        Trial.type='H Minor';
        Trial.rewardable=0;
