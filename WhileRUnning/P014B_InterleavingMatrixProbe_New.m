...
global Session;
    ...
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNumMCorrect)+(Session.ProbeNumVminusHplus+Session.ProbeNumVplusHminus+Session.ProbeNumMajor),1)=7; %For half correct makes half 1
      Session.trialList(Session.trialList(:,2)<=(Session.ProbeNumVminusHplus)+(Session.ProbeNumVplusHminus+Session.ProbeNumMajor),1)=8;%Making half of the remaining half equal to 2 (type 1 of incorrect)
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNumVplusHminus)+(Session.ProbeNumMajor),1)=9; %For half correct makes half 1    
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNumMajor),1)=10;
