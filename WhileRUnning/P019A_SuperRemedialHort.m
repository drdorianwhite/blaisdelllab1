...
global Session;
global Trial;
Session.codeUsed='P019A Super Remedial Hort'; %name of the code used for this session
...
Session.expName='P019A Super Remedial Hort'; %Name of the experiment
...
function RunStim() %function that runs the training stim
    ...
    if Session.trialList(Trial.curTrial) == 0; %see session setup
        dir = 'C:\Users\Admin\Desktop\JULIA\HortSmallCorrect\'; %then use this directory, which will only draw correct stim
        Trial.type='H Correct'; %specifies  the trial type
        Trial.rewardable=1;
    elseif Session.trialList(Trial.curTrial) == 1;
        dir = 'C:\Users\Admin\Desktop\JULIA\HortSmallMinor\'; %then use this directory, which only draw major rule violations
        Trial.type='H Minor'; %labels this trial type
        Trial.rewardable=0;
    else
        dir = 'C:\Users\Admin\Desktop\JULIA\HortSmallMinor\'; %makes the other option in the 1 if loop this directory
        Trial.type='H Minor';
        Trial.rewardable=0;
