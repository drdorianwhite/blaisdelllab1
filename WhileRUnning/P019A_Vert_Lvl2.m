...
global Session;
global Trial;
Session.codeUsed='P019A Vert Level 2'; %name of the code used for this session
...
Session.expName='P019A Vert Level 2'; %Name of the experiment
Trial.rule='Vert Lvl 2'; %Rule shown if changees by day read in under getbirddata
...
function RunStim() %function that runs the training stim
    ...
    elseif Session.trialList(Trial.curTrial) == 1;
        dir = 'C:\Users\Admin\Desktop\JULIA\VertMajorLevel2\'; %then use this directory, which only draw major rule violations
        Trial.type='V Major'; %labels this trial type
        Trial.rewardable=0;
    else
        dir = 'C:\Users\Admin\Desktop\JULIA\VertMinorLevel2\'; %makes the other option in the 1 if loop this directory
        Trial.type='V Minor';
        Trial.rewardable=0;
