...
global Session;
    ...
    Session.trialList(Session.trialList(:,2)<=(Session.VertNum)+(Session.HortNum+Session.ProbeNum),1)=1;
    Session.trialList(Session.trialList(:,2)<=((Session.VertNum/2)+(Session.HortNum+Session.ProbeNum)),1)=2;
    Session.trialList(Session.trialList(:,2)<=((Session.VertNum/4)+(Session.HortNum+Session.ProbeNum)),1)=3;
    
    Session.trialList(Session.trialList(:,2)<=(Session.HortNum)+Session.ProbeNum,1)=4; %For half correct makes half 1
    Session.trialList(Session.trialList(:,2)<=(Session.HortNum/2)+Session.ProbeNum,1)=5; %Making half of the remaining half equal to 2 (type 1 of incorrect)
    Session.trialList(Session.trialList(:,2)<=(Session.HortNum/4)+Session.ProbeNum,1)=6; %For half correct makes half 1
 
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNum),1)=7; %For half correct makes half 1
      Session.trialList(Session.trialList(:,2)<=(Session.ProbeNum/2),1)=10;%Making half of the remaining half equal to 2 (type 1 of incorrect)
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNum/4),1)=9; %For half correct makes half 1    
    Session.trialList(Session.trialList(:,2)<=(Session.ProbeNum/6),1)=8;
